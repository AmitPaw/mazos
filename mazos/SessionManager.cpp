...
void SessionManager::roundOver(int winner, int tresureValue)
{
	...
	if (_roundsCounter == ROUNDS)	
	{
		cout << endl << "******************************" << endl;
		cout <<"-GameOver-"<< endl;
		if (_mazeBoard.getPlayerOne().getScore() < _mazeBoard.getPlayerOne().getScore())
		{
			cout << endl << " " << _mazeBoard.getPlayerTwo().getName() << " Won with " << _mazeBoard.getPlayerTwo().getScore() << " Points\n";
		}
		else if (_mazeBoard.getPlayerOne().getScore() == _mazeBoard.getPlayerTwo().getScore())
		{
			cout << " a " << _mazeBoard.getPlayerTwo().getScore() << " Points drew!!\n";
		}
		{
			cout << " " << _mazeBoard.getPlayerOne().getName() << " Won with " << _mazeBoard.getPlayerOne().getScore() << " Points\n";
		}
		cout << "******************************" << endl;
	}
	else {
